...
export const REGULATION_CONSENT = {
  eu: [
    'BE',
    'BG',
    'CZ',
...
export const LIST_LANGUAGES = [
  ...
  {value: 'zh-cn', label: "Chinese (Simplified, People's Republic of China)"},
  {value: 'zh-hant', label: 'Chinese (Traditional) (zh-Hant)'},
  {value: 'zh-HK', label: 'Chinese (Traditional, Hong Kong S.A.R.)'},
  {value: 'zh-MO', label: 'Chinese (Traditional, Macao S.A.R.)'},
