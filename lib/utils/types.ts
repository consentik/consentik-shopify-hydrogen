...
export interface ImpressionData {
    ...
    bw: string; // browser
    dv: string; // device
    uid: string; // uid unique id
    dur: string | null; // duration waiting action after showing banner
}

export interface OptionalImpression extends Partial<ImpressionData>{}
